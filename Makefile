...
SRC = src/main.c 			src/builtins/builtins_utils.c  src/builtins/ft_exit_utils.c   src/lexing/token.c \
src/builtins/export_2.c		src/builtins/ft_export.c       src/lexing/utils_2.c \
src/builtins/export_3.c        src/builtins/ft_pwd.c          src/lexing/utils_3.c \
src/builtins/export_4.c        src/builtins/ft_unset.c        src/lexing/utils.c \
